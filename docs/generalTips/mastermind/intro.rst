...
The *Calculator Mastermind* spreadsheet serves as a planning tool that **gathers ideas** for the standard and marketing calculators. You can find it in the :ref:`Omni Common <omniLinks>` Google drive. Three of the tabs are especially interesting for calculatorians:

1. **Mastermind** — A list of calculators we want to create or we have already created. The Masterminders team updates it with new ideas from time to time. This worksheet is moderated by Dominik, so if you have any feedback or there is a lack of available calculators from your category, he is the right person to contact.  
...
3. **<idea graveyard>** — A sad list containing marketing ideas we have discarded for some reason. 

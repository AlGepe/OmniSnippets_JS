...
.. seealso::
    We have created a calculator using this code so that you can see the results for yourself. Check it out at `Dynamic Graphs (line) <https://www.omnicalculator.com/adminbb/calculators/1967>`__ on BB

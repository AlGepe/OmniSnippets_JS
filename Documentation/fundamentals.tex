...
\label{subsub:array}
So this is all well and good, but what happens when you have to mange hundreds or thousands of variables that are very similar to each other, or very closely related? \cancelto{<NOPE!>}{<You give up and focus on making a good text for the calculator.>}

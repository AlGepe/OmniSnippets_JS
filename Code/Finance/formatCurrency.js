...
function formatCurrency (number, currencySymbol, country) {
	...
	if (manualFormatBefore.includes(country)) {
		...
		var currencyCode = autoFormatCountries[country] ? autoFormatCountries[country][1] : 'USD';
		var userLang = autoFormatCountries[country] ? autoFormatCountries[country][0] : 'en-US';		
